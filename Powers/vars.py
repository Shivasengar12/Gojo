...
class Config:
    ...
    DB_NAME = config("DB_NAME", default="Kissebaatekru_bot")
    BDB_URI = config("BDB_URI",default=None)
    NO_LOAD = config("NO_LOAD", default="").split()
    PREFIX_HANDLER = config("PREFIX_HANDLER", default="/").split()
    SUPPORT_GROUP = config("SUPPORT_GROUP", default="mastiwithfriendsx")
    SUPPORT_CHANNEL = config("SUPPORT_CHANNEL", default="mastiwithfriendsx")
