...
basicConfig(
    format="%(asctime)s - [STRANGER_ROBO] - %(levelname)s - %(message)s",
    level=INFO,
...
LOGGER.info("------------------------")
LOGGER.info("|      Kissebaatekru_bot     |")
LOGGER.info("------------------------")
LOGGER.info(f"Version: {VERSION}")
LOGGER.info(f"Owner: {str(Config.OWNER_ID)}")
LOGGER.info(f"Time zone set to {Config.TIME_ZONE}")
LOGGER.info("Source Code: https://te.legra.ph/file/ebc3fc421b8776e29ad98.mp4")
